<%-- 
    Document   : admin_home
    Created on : Feb 25, 2024, 8:54:39 PM
    Author     : huy08
--%>
...
<html>
    ...
    <body>
        ...
        <nav>
            ...
            <ul class="bar">
                <li><a href="#">This is Admin Home</a></li>
                <li>
                    <a href="#">List<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M480-360 280-560h400L480-360Z"/></svg></a>
